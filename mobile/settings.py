...
SECRET_KEY = 'django-insecure-9-ya^+ql0(9%lsq6qt-epx+p%c$b6$t+s$o@l@o=015bi$q2gt'
...
import os
STATIC_URL = 'static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR,'mymobile/static')]
