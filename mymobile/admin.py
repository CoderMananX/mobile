...
def export_to_pdf(modeladmin, request, queryset):
   ...
   headers = ["Total_amount","L_id","Address","order_status","Payment_status","Date_time"]

   # Create the table data
   data = []
   for obj in queryset:
       data.append([obj.Total_amount, obj.L_id, obj.Address,obj.order_status,obj.Payment_status,obj.Date_time])
...
class Product_Order(admin.ModelAdmin):
    list_display = ["L_id","Address","Total_amount","order_status","Date_time"]
